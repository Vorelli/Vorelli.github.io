                ...
                this.createItemForSlot(
                  {
                    ...this.loginParsed,
                    label: h
                      ? `${g("Hello", this.el.lang)} ${(r = this.loginParsed.customer) === null || r === void 0 ? void 0 : r.fullName
                      }`
...
const Vz = class {
  ...
  navigationChanged() {
    return this.main.navigationChanged();
  }
  indexChanged() {
    return this.main.indexChanged();
  }
  loginChanged() {
    return this.main.loginChanged();
  }
  slotsChanged() {
    return this.main.slotsChanged();
  }
  onKeyDown(e) {
    return this.main.onKeyDown(e);
  }
  onWindowMouseup(e) {
    return this.main.onWindowMouseup(e);
  }
  onWindowScroll() {
    return this.main.onWindowScroll();
  }
  onWindowResizeDebounced() {
    return this.main.onWindowResizeDebounced();
  }
  async openSlot(e) {
    return this.main.openSlot(e);
  }
  async closeSlot(e) {
    return this.main.closeSlot(e);
  }
  async getNavigationHelpers() {
    return this.main.getNavigationHelpers();
  }
  constructor(e) {
    t(this, e);
    this.main = new Pt(e);
  ...
  componentDidLoad() {
    return this.main.componentDidLoad();
  }
  componentDidUpdate() {
    return this.main.componentDidUpdate();
  }
  headerMenuDisplayChangeCallback(e, t, i) {
  ...
  onExternalLinkClick(e, t) {
    return this.main.onExternalLinkClick(e, t);
  }
  createBreadcrumbListScriptEl() {
    return this.main.createBreadcrumbListScriptEl();
  }
  createListForDesktop(t, i, n) {
    return this.main.createListForDesktop(t, i, n);
  }
  createListForMobile(t, i) {
    return this.main.createListForMobile(t, i);
  }
  getMaxDepth(e, t = [], i = []) {
    return this.main.getMaxDepth(e, t, i);
  }
  createBreadcrumbListSchema() {
    return this.main.createBreadcrumbListSchema();
  }
  getMetaHeight() {
    return this.main.getMetaHeight();
  }
  hasBreadcrumbs() {
    return this.main.hasBreadcrumbs();
  }
  hasLeftHandMenu() {
    return this.main.hasLeftHandMenu();
  }
  getLeftHandMenuItems() {
    return this.main.getLeftHandMenuItems();
  }
  getBackdropStyle(e) {
    return this.main.getBackdropStyle(e);
  }
  layout() {
    return this.main.layout();
  }
  showSecondaryIfEnoughSpace() {
    return this.main.showSecondaryIfEnoughSpace();
  }
  showSlotLabelsIfEnoughSpace() {
    return this.main.showSlotLabelsIfEnoughSpace();
  }
  setDisplayToDesktopOrMobile() {
    return this.main.setDisplayToDesktopOrMobile();
  }
  makeHeaderSticky() {
    return this.main.makeHeaderSticky();
  }
  hidePartsOnMobile() {
    return this.main.hidePartsOnMobile();
  }
  createItemForMeta(t) {
    return this.main.createItemForMeta(t);
  }
  createItemForMain(t) {
    return this.main.createItemForMain(t);
  }
  createItemForSlot(t, i, n) {
    return this.main.createItemForSlot(t, i, n);
  }
  createInitials(e) {
    return this.main.createInitials(e);
  }
  getComponentClassNames() {
    return { component: true, closed: true, [k(this.el)]: true };
  }
...
export { Pt as sdx_header, Vz as sdx_header_left_hand_menu, Vz as sdx_header_menu };
//export { aaaa as sdx_header, aaaa as sdx_header_left_hand_menu, aaaa as sdx_header_menu };
